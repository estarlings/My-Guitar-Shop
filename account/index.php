...
$email->Username   = "erikaugtech@gmail.com"; // SMTP account username Will need to be modified
$email->Password   = "sdyonctinarzybmq";        // SMTP account password Will need to be modified
$email->SetFrom('erikaugtech@gmail.com', 'Erik');  //Will need to be modified – identifies email of sender
$email->MsgHTML($message);
$email->SingleTo  = true;	// true allows that only one person will receive an email per array group
$email->From      = 'erikaugtech@gmail.com'; //Will need to be modified – identifies email of sender
